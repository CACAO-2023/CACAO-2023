...
public class Producteur2APPVendeurBourse extends Producteur2AProducteurPlanteur implements IVendeurBourse{
	
	public Producteur2APPVendeurBourse(Feve feve, double stock) {
