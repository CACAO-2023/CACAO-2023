...
public class Producteur2Acteur implements IActeur {
	...
	protected Variable stepsVecuesPourBourseMQ_BE = new VariablePrivee("EQ2 seuil vente en bourse MQ_BE", "seuil d'ancienneté de vente de MQ_BE en bourse", this, 10);
	protected Variable stepsVecuesPourBourseMQ = new VariablePrivee("EQ2 seuil vente en bourse MQ", "seuil d'ancienneté de vente obligatoire de MQ en bourse", this, 10);
	protected Variable stepsVecuesPourBourseBQ = new VariablePrivee("EQ2 seuil vente en bourse BQ", "seuil d'ancienneté de vente obligatoire de MQ_BE en bourse", this, 10);
