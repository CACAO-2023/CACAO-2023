				...
				for (IVendeurContratCadre vendeur : vendeurs) {
					if (!vendeur.equals(this)) {
						if (cm.getGamme().equals(Gamme.BQ)){
							...
							this.journal_CC_PROD.ajouter(COLOR_LLGRAY, Color.BLUE, " CCA_BQ : tentative d'achat aupres de "+vendeur);
						...
						if (cm.getGamme().equals(Gamme.HQ)){
							...
							this.journal_CC_PROD.ajouter(COLOR_LLGRAY, Color.BLUE, " CCA_HQ : tentative d'achat aupres de "+vendeur);
