...
public class Producteur3Acteur implements IActeur {
	...
	this.EsperanceGaussienneProduction = new Variable("Moyenne gaussienne pour production", "Fixe l'esperance de la gaussienne permettant d'avoir le pourcentage de feves recoltes",this,480);
