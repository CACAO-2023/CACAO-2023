...
public interface IAcheteurContratCadre extends IActeur {
     ...
     * a partir des feves de ce contrat cadre.
     */
	public int fixerPourcentageRSE(IAcheteurContratCadre acheteur, IVendeurContratCadre vendeur, IProduit produit, Echeancier echeancier, long cryptogramme, boolean tg);
